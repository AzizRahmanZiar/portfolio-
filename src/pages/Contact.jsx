    ...
    <section className="mx-auto max-w-5xl px-4 py-16 space-y-10">
      <header className="space-y-3">
        ...
        <p className="max-w-3xl text-base text-slate-300">
          I work with SaaS teams, founders, and agencies. Tell me about your
          roadmap, timelines, and success metrics—I’ll share how I can help.
        </p>
      </header>
      ...
      <div className="grid gap-6 lg:grid-cols-2">
        <div className="space-y-6 rounded-3xl border border-slate-800 bg-slate-900/30 p-6">
          ...
          <div className="space-y-4 text-sm text-slate-200">
            ...
            <p>
              ...
              <br />
              <a href="tel:+93702492682" className="text-sky-400 hover:underline">
                +93 702 492 682
              </a>
              <span className="text-slate-400"> · </span>
              <a href="tel:+93747214110" className="text-sky-400 hover:underline">
                +93 747 214 110
              </a>
            </p>
            <p>
              <span className="font-medium text-slate-100">Calendly</span>
              <br />
        ...
        <div className="space-y-4 rounded-3xl border border-slate-800 bg-slate-900/40 p-6">
          ...
          <p className="text-sm text-slate-300">
            ...
            voice note and I’ll reply within 24 hours.
          </p>
          ...
          <div className="rounded-2xl border border-slate-800 bg-slate-950/40 p-4 text-sm text-slate-300">
            ...
            <p>+93 702 492 682 · +93 747 214 110</p>
          </div>
        </div>
      </div>
    </section>
