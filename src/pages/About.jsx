    ...
    <section className="mx-auto max-w-5xl px-4 py-16 space-y-10">
      <header className="space-y-4">
        ...
        <p className="text-base text-slate-300 leading-relaxed">
          I build user-friendly websites with React, Next.js, Tailwind CSS, and
          JavaScript. As a beginner developer growing on Fiverr and remote
          platforms, I focus on clean layouts, readable code, and smooth flows
          that help people trust your brand.
        </p>
        <p className="text-base text-slate-300 leading-relaxed">
        ...
        <div className="space-y-4">
          <div className="rounded-3xl border border-slate-800 bg-slate-900/40 p-6">
            ...
            <p className="text-sm text-slate-300">
              ...
              JavaScript, React, Next.js, and Tailwind CSS. I build modern,
              responsive websites with a focus on clean UI, smooth performance,
              and easy navigation. I enjoy turning ideas into working products
              and helping clients grow online.
            </p>
          </div>
