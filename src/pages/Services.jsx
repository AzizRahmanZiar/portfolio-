const services = [
  ...
  },
  {
    ...
    description:
      'Single-page applications, dashboard interfaces, and component-driven products powered by React or Next.js.',
  },
  {
    title: 'Figma/XD to production-ready code',
    description:
      'Pixel-perfect implementation of your design files using Tailwind CSS, Bootstrap, or custom SCSS.',
  },
  {
  ...
  },
  {
    ...
    description:
      'Hook up REST/JSON APIs, handle auth flows, and create reusable services for clean data fetching.',
  },
  {
    ...
    <section className="mx-auto max-w-5xl px-4 py-16 space-y-8">
      ...
      <div className="rounded-3xl border border-slate-800 bg-slate-900/30 p-6 text-center">
        <p className="text-sm text-slate-300">
          Need something custom like an Upwork/Fiverr profile, resume, or full
          Next.js starter? I can prepare deliverables that fit your exact goals.
        </p>
        <a
